...
if draw_f_9:
    ...
    bppos = [
            [0.06, 0.15, bbdim[0],bbdim[1]],
            [0.34, 0.15, bbdim[0],bbdim[1]],
            [0.62, 0.15, bbdim[0],bbdim[1]],
            ]
    ...
    ax1.yaxis.set_label_coords(-0.15, 0.5, transform=ax1.transAxes)
    ax1.xaxis.set_label_coords(0.5, -0.08, transform=ax1.transAxes)
    ...
    ax2.xaxis.set_label_coords(0.5, -0.08, transform=ax2.transAxes)
    ...
    ax2.legend([handles[idx] for idx in order],[labels[idx] for idx in order],
               ncol = 1, fontsize=fontsize,  bbox_to_anchor=(0.96, 0.92),
    ...
    ax3.legend([handles[idx] for idx in order],[labels[idx] for idx in order],
               ncol = 1, fontsize=fontsize,  bbox_to_anchor=(0.85, 0.50),
               bbox_transform=plt.gcf().transFigure,
               columnspacing=1, handletextpad=0.35)
    ...
    ax3.xaxis.set_label_coords(0.5, -0.08, transform=ax3.transAxes)
