...
ax5.set_xlabel('Air-filled porosity (m$^3$ m$^{-3}$)')
...
ax6.set_xlabel('Air-filled porosity (m$^3$ m$^{-3}$)')
...
ax8.set_xlabel('Air-filled porosity (m$^3$ m$^{-3}$)')
...
ax9.set_xlabel('Air-filled porosity (m$^3$ m$^{-3}$)')
